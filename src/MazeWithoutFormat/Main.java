...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //New object position with parameters
        Position myPosition = new Position(0, 3);
        ...
        while (true) {
            ...
            if (isValid(y + 1, x)) {
                //Move down
                if (mazeData[y + 1][x] == 2) {
                    System.out.println("Down You won!");
                    return;
            ...
            if (isValid(y, x - 1)) {
                //Move Left
                if (mazeData[y][x - 1] == 2) {
                    System.out.println("Left You won!");
                    return;
